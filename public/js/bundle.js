...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(10), __webpack_require__(90)(module)))
...
var _categoriesContainer = __webpack_require__(100);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(_categoriesContainer2.default, null);
    }
  }]);
...
var _categories_actions = __webpack_require__(174);

var _categoriesIndex = __webpack_require__(101);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    requestAllCategories: function requestAllCategories() {
      return dispatch((0, _categories_actions.requestAllCategories)());
    }
  };
};

var CategoriesContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_categoriesIndex2.default);
...
var CategoriesIndex = function (_React$Component) {
  ...
  _createClass(CategoriesIndex, [{
    ...
    value: function render() {
      ...
      var allIDs = Object.keys(categories.byID);
      var categoriesList = allIDs.map(function (id, idx) {
        return _react2.default.createElement(
          'li',
          { key: idx },
...
exports.default = CategoriesIndex;
...
var configureStore = function configureStore() {
  ...
  return (0, _redux.createStore)(_rootReducer2.default, initialState, (0, _redux.applyMiddleware)(_reduxThunk2.default, _reduxLogger2.default));
};
...
var _categoriesReducer = __webpack_require__(106);
...
var categoriesReducer = function categoriesReducer() {
  ...
  switch (action.type) {
    case _categories_actions.RECEIVE_CATEGORIES:
      var newState = {};
      action.payload.data.forEach(function (el) {
        newState[el['_id']] = el;
      });
      return {
        byID: newState
...
exports.receiveCategories = exports.requestAllCategories = exports.RECEIVE_CATEGORIES = undefined;

var _categories_api_util = __webpack_require__(182);

var RECEIVE_CATEGORIES = exports.RECEIVE_CATEGORIES = 'RECEIVE_CATEGORIES';

var requestAllCategories = exports.requestAllCategories = function requestAllCategories() {
  return function (dispatch) {
    return (0, _categories_api_util.fetchCategories)().then(function (categories) {
...
exports.fetchCategories = undefined;
...
var _categories_actions2 = _interopRequireDefault(_categories_actions);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var fetchCategories = exports.fetchCategories = function fetchCategories() {
  return _axios2.default.get('/api/categories');
};
